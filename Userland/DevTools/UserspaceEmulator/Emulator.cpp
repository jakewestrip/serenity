...
void Emulator::dispatch_one_pending_signal()
{
    ...
    constexpr static FlatPtr elements_pushed_on_stack_before_handler_address = 2; // two slots for saved registers
    ...
    m_cpu->push32(shadow_wrap_as_initialized(0u)); // bp slot
    ...
    // FPU state, leave a 512-byte gap.
